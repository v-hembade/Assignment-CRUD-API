    ...
    public class AuthService : IAuthService
    {
        ...
        public bool AssignRoleToUser(AddUserRole obj)
        {
            ...
            try
            {
                ...
                var user = _context.User.SingleOrDefault(s => s.Id == obj.UserId);
                if (user == null)
        ...
        public string Login(LoginRequest loginRequest)
        {
            ...
            {
                var user = _context.User.SingleOrDefault(s => s.Username == loginRequest.Username && s.Password == loginRequest.Password);
                if (user != null)
                {
